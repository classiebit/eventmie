<template>
    <div class="container">
        <div class="py-4 py-lg-5 mt-6">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <event-listing :events="events" :date_format="date_format"
                ...
                this.$router
                    .push({
                        query: Object.assign({}, this.$route.query, {
                            category: this.slugifyCategory(this.f_category),
                            page: 1,
                        }),
                    })
                    .catch(() => { });
    ...
    methods: {
        ...
        slugifyCategory(category) {
            ...
            return category
                ...
                .replace(/[\s\_]+/g, '-')      // spaces or underscores → single dash
